...
using UnityEngine;
using FMOD;
using CultMusicLoader.Sounds.Helpers;

namespace CultMusicLoader.Sounds.Load;
public class SoundLoader : MonoBehaviour
{
    ...
    public Sound GetSound(string name)
    {
        ...
        {
            Plugin.myLogger.LogError($"Couldn't get sound {name}: Sound doesn't exist!");
    ...
    public void PlaySFX(string name)
    {
        if (!Sounds.ContainsKey(name))
        {
            Plugin.myLogger.LogError($"Error playing sound {name}: Sound doesn't exist!");
        }
